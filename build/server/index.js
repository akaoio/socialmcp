...
defmod('./src/book.js', function(module, exp){
 ...
 // before we assume this is an insert tho, we need to check
    if (page && page.from) {
  ...
  Zen.chain.get = function (key, cb, as) {
    ...
    if (typeof key === "string") {
      ...
      function any(msg, eve, f) {
        ...
        if (("string" == typeof (tmp = Zen.valid(data)))) {
...
defmod('./src/axe.js', function(module, exp){
  ...
  function loadService(root) {
    ...
    __servicePromise = __servicePromise || Promise.resolve().then(function () { return _zenServiceStub$1; });
...
ZEN.on("opt", function (root) {
  ...
  opt.WebSocket = opt.WebSocket || NativeWebSocket;
...
function _zenServiceStub(){}

var _zenServiceStub$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: _zenServiceStub
});
